...
beta = 0.7 * pow(num_of_hidden_units, 0.5)
...
for h in range(len(hidden_layer_weights)):
    sqr_intializer = h ** 2
norm_initializer = pow(sqr_intializer, 0.5)
...
for h in range(num_of_hidden_units):
    hidden_layer_weights[h] = hidden_layer_weights[h] * beta / norm_initializer

print("Hidden layer weights : ", hidden_layer_weights)


nn = NeuralNetwork(num_of_inputs, num_of_hidden_units, num_of_outputs, hidden_layer_weights, hidden_layer_bias)
err = []
